"""
⛔ ЭТОТ ФАЙЛ НЕ ИСПОЛЬЗУЕТСЯ В ПРОДАКШЕНЕ

Единственный бот КотЭ (@phuket_nestandart_bot) живёт в:
  → n8n Cloud: ibetekhtin.app.n8n.cloud
  → Workflow: «КотЭ — AI Агент с памятью»
  → Движок: Google Gemini 2.0 Flash

НЕ ЗАПУСКАТЬ этот файл — будет конфликт webhook/polling.
Код сохранён как справочный архив.
"""
...
- Рисуй картинку, а не прайс: сначала опиши впечатление, потом назови тур и цену из каталога.
